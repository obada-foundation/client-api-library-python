...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ObitApi()
        api_instance.download_obit_from_chain  # this is an instance of the class Endpoint
        api_instance.download_obit_from_chain()  # this invokes api_instance.download_obit_from_chain.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.download_obit_from_chain.callable or self.callable in this class
