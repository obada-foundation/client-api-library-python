...
class LocalObit(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'metadata': ([LocalObitMetadataInner],),  # noqa: E501
            'documents': ([LocalObitDocumentsInner],),  # noqa: E501
            'structured_data': ([LocalObitStructuredDataInner],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, owner, obit_status, manufacturer, part_number, serial_number, modified_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata ([LocalObitMetadataInner]): Get description from Rohi. [optional]  # noqa: E501
            documents ([LocalObitDocumentsInner]): To generate this link, take an SHA-256 hash of the document, and link to it as https://www.some-website.com?h1=hash-of-document. Note this does not yet adhere to the hashlink standard. . [optional]  # noqa: E501
            structured_data ([LocalObitStructuredDataInner]): Same as metadata but bigger. Key (string) => Value (string) (hash per line sha256(key + value)). [optional]  # noqa: E501
        """
